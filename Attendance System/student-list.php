...
$sql = "SELECT Student_ID, studentName, Contact, Program, Class FROM student $whereClause ORDER BY Class ASC, studentName ASC";
    ...
    <div class="container-box">
        ...
        <form method="get" class="row g-3 justify-content-center mb-4">
            ...
            <div class="col-md-auto d-flex align-items-end">
                <button type="submit" class="btn btn-orange me-2">Filter</button>
            ...
            <table>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>+60" . htmlspecialchars($row['Contact']) . "</td>
                ...
                if ($no === 1) {
                    echo "<tr><td colspan='6' class='text-center py-3'>No students found.</td></tr>";
                }
                ?>
                </tbody>
            </table>
